...
import {
  ...
  IonList, IonSpinner, IonTitle, IonToolbar, IonButtons, IonBackButton, IonIcon
} from '@ionic/angular';
...
@Component({
  ...
  imports: [
    ...
    IonItem, IonLabel, IonList, IonSpinner, IonTitle, IonToolbar, IonButtons, IonBackButton, IonIcon
  ],
